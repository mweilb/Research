...
using MinecraftFabrics.ActorServices.Interface;
using System;
...
{
    class InformActor : Actor, IInformActor
    {
        ...
        public async Task<InformOfChunkChangeResponse> InformOfChange(ActorId[] observer, AssociateChunkMetaData associate, TrackingChunkMetaData tracking)
        {
            ...
            response.actorID = this.Id;
            response.availableBlocks = nBlocksLeft;
            response.availablePlayers = nPlayersLeft;
            response.lastPlayersVersion = lastPlayerUsedVersion;
            response.lastBlockVersion = lastBlockUsedVersion;
                               ...
                               BlockMetaData[] blocks, PlayerMetaData[] players)
        {
            ...
            GatherChanges(minBlockVersionNumber,  maxBlockVersionNumber, suggestedMaxBlocksRequests, 
                          ...
                          out nBlocks, out nPlayers, out nBlocksLeft, out nPlayersLeft, 
